import cgitb, cgi
from scriptspython import TempoCalculo
...
print("</head>")
print("<body>")
print("<h1>Resultado cálculo conversão de tempo</h1><br>")
print("<a href='../tempo.html'><-Retornar para página do conversão</a><br>")
